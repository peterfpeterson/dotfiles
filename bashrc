...
export MAMBA_EXE='/home/pf9/.local/bin/micromamba';
export MAMBA_ROOT_PREFIX='/home/pf9/micromamba';
...
if [ "$(command -v eza)" ]; then
   ...
   alias eza="eza --icons --time-style=iso --git --group-directories-first --hyperlink=auto"
   alias ls="eza"
